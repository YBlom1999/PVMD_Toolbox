function [Lay,Int,rback,TYPE,absmat,SubMod_ind] = Tandem_4T
...
load('AFM.mat','pyramids_20um','AsahiU_20um')  %load texture hight map from file [um]
...
Int(2).coat(1).med = 'FTO';                  Int(2).coat(1).thi = 0.200;
Int(2).coat(2).med = 'SnO2-Man18';           Int(2).coat(2).thi = 0.005;
Int(2).coat(3).med = 'C60';                  Int(2).coat(3).thi = 0.007;
Int(2).coat(4).med = 'perovskite-1.68eV-Man18-Eg-705-715';         Int(2).coat(4).thi = 0.550;
Int(2).coat(5).med = 'PTAA';                 Int(2).coat(5).thi = 0.023;
Int(2).coat(6).med = 'FTO';                  Int(2).coat(6).thi = 0.200;
    
%For 4T a buffer layer could be added here
Int(3).coat(1).med = 'IWO_g';                  Int(3).coat(1).thi = 0.063;
Int(3).coat(2).med = 'n-SiOx-ncSi';          Int(3).coat(2).thi = 0.012;
...
Int(4).coat(4).med = 'Ag';                   Int(4).coat(4).thi = 0.3;
  ...
  %---
Int(2).model = 'wave';                        %use WAVE-optics model
Int(2).Z = -AsahiU_20um;                   Int(2).xy = [20e-6,20e-6];        %20x20um map
  %---
