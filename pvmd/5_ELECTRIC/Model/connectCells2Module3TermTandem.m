function [V_module,I_module] = connectCells2Module3TermTandem(V_1,V_2,numCells,I,day,night,configuration,VM_ratio_m,VM_ratio_n)
...
V_1=reshape(V_1,numCells,length(day),length(I));
V_2=reshape(V_2,numCells,length(day),length(I));
