function [RSD_i_dir,RSD_f_dir,RSD_i_dif,RSD_f_dif,air_mass,wav_new] = spectral_distrSBDart(wav,constants)
...
specDirClear = cell2mat(readcell('spectraSBDART.xlsx',"Sheet","Direct","Range","B3:CN3723"));
specDirPartial = cell2mat(readcell('spectraSBDART.xlsx',"Sheet","Direct","Range","CP3:GB3723"));
specDirClouded = cell2mat(readcell('spectraSBDART.xlsx',"Sheet","Direct","Range","GD3:JP3723"));

specDifClear = cell2mat(readcell('spectraSBDART.xlsx',"Sheet","Diffuse","Range","B3:CN3723"));
specDifPartial = cell2mat(readcell('spectraSBDART.xlsx',"Sheet","Diffuse","Range","CP3:GB3723"));
specDifClouded = cell2mat(readcell('spectraSBDART.xlsx',"Sheet","Diffuse","Range","GD3:JP3723"));

sbdartSpec.solarZenith = 0:(size(specDirClear,2)-1);
sbdartSpec.lambda = cell2mat(readcell('spectraSBDART.xlsx',"Sheet","Direct","Range","A3:A3723"));
sbdartSpec.direct = cat(3,specDirClear,specDirPartial,specDirClouded);
sbdartSpec.diffuse = cat(3,specDifClear,specDifPartial,specDifClouded);

air_mass = 1./sind(90-sbdartSpec.solarZenith(1:end-1));
wavelengths = sbdartSpec.lambda/1e9;
