function cell_temp = individual_cell_FD(ambient_temp,wind_speed,cell_abs,...
    TOOLBOX_input,MODULE_output,Mod_i)
...
if TOOLBOX_input.runPeriodic
    ...
    number_cells=MODULE_output.N(Mod_i);
    % cell_area         area of the PV cell (cm2), convert from m2
    cell_area=MODULE_output.A(Mod_i)*10000;
    ...
    ModMountHeight=0.01*TOOLBOX_input.Scene.module_mounting(Mod_i).zCoordinate; 
    % number_cells      number of cells in a module
    number_cells=MODULE_output.Panels(Mod_i).Ncells;
    % cell_area         area of the PV cell (cm2), convert from m2
    cell_area=MODULE_output.Panels(Mod_i).Acell*10000;
    % tilt              tilt of the module (degrees)
    tilt=MODULE_output.ModTilt;
    % glass_area        area of the glass (cm2) per cell
    glass_area=MODULE_output.Panels(Mod_i).Amod*10000/number_cells;
end
