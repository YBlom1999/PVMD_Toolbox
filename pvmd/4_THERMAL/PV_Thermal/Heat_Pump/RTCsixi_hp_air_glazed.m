...
% Combined with air_based_glazed_collector
% 12-23
%
% Parameters
% ----------
...
if (Tam(i)>=12.5) && (Tam(i)<13)
    O_hp(i) = O(36);
elseif (Tam(i)>=12) && (Tam(i)<12.5)
    O_hp(i) = O(35);
elseif (Tam(i)>=11.5) && (Tam(i)<12)
    O_hp(i) = O(34);
elseif (Tam(i)>=11) && (Tam(i)<11.5)
    O_hp(i) = O(33);
elseif (Tam(i)>=10.5) && (Tam(i)<11)
    O_hp(i) = O(32);
elseif (Tam(i)>=10) && (Tam(i)<10.5)
    O_hp(i) = O(31);
elseif (Tam(i)>=9.5) && (Tam(i)<10)
    O_hp(i) = O(30);
elseif (Tam(i)>=9) && (Tam(i)<9.5)
    O_hp(i) = O(29);
elseif (Tam(i)>=8.5) && (Tam(i)<9)
    O_hp(i) = O(28);
elseif (Tam(i)>=8) && (Tam(i)<8.5)
    O_hp(i) = O(27);
elseif (Tam(i)>=7.5) && (Tam(i)<8)
    O_hp(i) = O(26);
elseif (Tam(i)>=7) && (Tam(i)<7.5)
    O_hp(i) = O(25);
elseif (Tam(i)>=6.5) && (Tam(i)<7)
    O_hp(i) = O(24);
elseif (Tam(i)>=6) && (Tam(i)<6.5)
    O_hp(i) = O(23);
elseif (Tam(i)>=5.5) && (Tam(i)<6)
    O_hp(i) = O(22);
elseif (Tam(i)>=5) && (Tam(i)<5.5)
    O_hp(i) = O(21);
elseif (Tam(i)>=4.5) && (Tam(i)<5)
    O_hp(i) = O(20);
elseif (Tam(i)>=4) && (Tam(i)<4.5)
    O_hp(i) = O(19);
elseif (Tam(i)>=3.5) && (Tam(i)<4)
    O_hp(i) = O(18);
elseif (Tam(i)>=3) && (Tam(i)<3.5)
    O_hp(i) = O(17);
elseif (Tam(i)>=2.5) && (Tam(i)<3)
    O_hp(i) = O(16);
elseif (Tam(i)>=2) && (Tam(i)<2.5)
    O_hp(i) = O(15);
elseif (Tam(i)>=1.5) && (Tam(i)<2)
    O_hp(i) = O(14);
elseif (Tam(i)>=1) && (Tam(i)<1.5)
    O_hp(i) = O(13);
elseif (Tam(i)>=0.5) && (Tam(i)<1)
    O_hp(i) = O(12);
elseif (Tam(i)>=0) && (Tam(i)<0.5)
    O_hp(i) = O(11);
elseif (Tam(i)>= -0.5) && (Tam(i)<0)
    O_hp(i) = O(10);
elseif (Tam(i)>= -1) && (Tam(i)< -0.5)
    O_hp(i) = O(9);
elseif (Tam(i)>= -1.5) && (Tam(i)< -1)
    O_hp(i) = O(8);
elseif (Tam(i)>= -2) && (Tam(i)< -1.5)
    O_hp(i) = O(7);
elseif (Tam(i)>= -2.5) && (Tam(i)< -2)
    O_hp(i) = O(6);
elseif (Tam(i)>= -3.25) && (Tam(i)< -2.5)
    O_hp(i) = O(5);
elseif (Tam(i)>= -4.25) && (Tam(i)< -3.25)
    O_hp(i) = O(4);
elseif (Tam(i)>= -5.25) && (Tam(i)< -4.25)
    O_hp(i) = O(3);
elseif (Tam(i)>= -6.25) && (Tam(i)< -5.25)
    O_hp(i) = O(2);
elseif (Tam(i)>= -7.5) && (Tam(i)< -6.25)
    O_hp(i) = O(1);
else
    O_hp(i) = 0;
end
...
if O_hp(i) <= 0
    COP_hp(i) = 0;
elseif (O_hp(i)<=O(36)) && (O_hp(i)>O(35))
    COP_hp(i) = COP(36);
elseif (O_hp(i)<=O(35)) && (O_hp(i)>O(34))
    COP_hp(i) = COP(35);
elseif (O_hp(i)<=O(34)) && (O_hp(i)>O(33))
    COP_hp(i) = COP(34);
elseif (O_hp(i)<=O(33)) && (O_hp(i)>O(32))
    COP_hp(i) = COP(33);
elseif (O_hp(i)<=O(32)) && (O_hp(i)>O(31))
    COP_hp(i) = COP(32);
elseif (O_hp(i)<=O(31)) && (O_hp(i)>O(30))
    COP_hp(i) = COP(31);
elseif (O_hp(i)<=O(30)) && (O_hp(i)>O(29))
    COP_hp(i) = COP(30);
elseif (O_hp(i)<=O(29)) && (O_hp(i)>O(28))
    COP_hp(i) = COP(29);
elseif (O_hp(i)<=O(28)) && (O_hp(i)>O(27))
    COP_hp(i) = COP(28);
elseif (O_hp(i)<=O(27)) && (O_hp(i)>O(26))
    COP_hp(i) = COP(27);
elseif(O_hp(i)<=O(26)) && (O_hp(i)>O(25))
    COP_hp(i) = COP(26);
elseif (O_hp(i)<=O(25)) && (O_hp(i)>O(24))
    COP_hp(i) = COP(25);
elseif (O_hp(i)<=O(24)) && (O_hp(i)>O(23))
    COP_hp(i) = COP(24);
elseif (O_hp(i)<=O(23)) && (O_hp(i)>O(22))
    COP_hp(i) = COP(23);
elseif (O_hp(i)<=O(22)) && (O_hp(i)>O(21))
    COP_hp(i) = COP(22);
elseif (O_hp(i)<=O(21)) && (O_hp(i)>O(20))
    COP_hp(i) = COP(21);
elseif (O_hp(i)<=O(20)) && (O_hp(i)>O(19))
    COP_hp(i) = COP(20);
elseif (O_hp(i)<=O(19)) && (O_hp(i)>O(18))
    COP_hp(i) = COP(19);
elseif (O_hp(i)<=O(18)) && (O_hp(i)>O(17))
    COP_hp(i) = COP(18);
elseif (O_hp(i)<=O(17)) && (O_hp(i)>O(16))
    COP_hp(i) = COP(17);
elseif (O_hp(i)<=O(16)) && (O_hp(i)>O(15))
    COP_hp(i) = COP(16);
elseif (O_hp(i)<=O(15)) && (O_hp(i)>O(14))
    COP_hp(i) = COP(15);
elseif(O_hp(i)<=O(14)) && (O_hp(i)>O(13))
    COP_hp(i) = COP(14);
elseif (O_hp(i)<=O(13)) && (O_hp(i)>O(12))
    COP_hp(i) = COP(13);
elseif (O_hp(i)<=O(12)) && (O_hp(i)>O(11))
    COP_hp(i) = COP(12);
elseif (O_hp(i)<=O(11)) && (O_hp(i)>O(10))
    COP_hp(i) = COP(11);
elseif (O_hp(i)<=O(10)) && (O_hp(i)>O(9))
    COP_hp(i) = COP(10);
elseif (O_hp(i)<=O(9)) && (O_hp(i)>O(8))
    COP_hp(i) = COP(9);
elseif (O_hp(i)<=O(8)) && (O_hp(i)>O(7))
    COP_hp(i) = COP(8);
elseif (O_hp(i)<=O(7)) && (O_hp(i)>O(6))
    COP_hp(i) = COP(7);
elseif (O_hp(i)<=O(6)) && (O_hp(i)>O(5))
    COP_hp(i) = COP(6);
elseif (O_hp(i)<=O(5)) && (O_hp(i)>O(4))
    COP_hp(i) = COP(5);
elseif (O_hp(i)<=O(4)) && (O_hp(i)>O(3))
    COP_hp(i) = COP(4);
elseif (O_hp(i)<=O(3)) && (O_hp(i)>O(2))
    COP_hp(i) = COP(3);
elseif (O_hp(i)<=O(2)) && (O_hp(i)>O(1))
    COP_hp(i) = COP(2);
elseif (O_hp(i)<=O(1)) && (O_hp(i)>0)
    COP_hp(i) = COP(1);
end

P_hp(i) = O_hp(i)/COP_hp(i);
% if COP_hp(i) <= 0
%     P_hp(i) = 0;
% end
end
...
pvt_collector_output.P_hp=P_hp;
pvt_collector_output.O_hp=O_hp;
...
f = figure(1013);
plot(xx,O_hp,'DisplayName','O_{hp}')
ylabel('Output [W]')
yyaxis right
plot(xx,P_hp, 'DisplayName','P_{hp}')
...
if time/24 >=31
    ...
    f = figure(1014);
plot(xx,COP_hp,'DisplayName','COP')
