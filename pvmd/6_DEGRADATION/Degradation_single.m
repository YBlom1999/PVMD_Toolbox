...
%modules
%
% This function calculates the degradation rate of a single junction module
% 
%
% Parameters
% ----------
...
Jph_repeat = repmat(CONSTANTS.q*mean(WEATHER_output.J{1},2),[N_years,1])';
...
TOOLBOX_input_new.electric.deg_bot.k_mois = sum(k_mois);
