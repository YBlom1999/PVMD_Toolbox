function Losses_Operating = Analysis_Operating_skipIrradiance(TOOLBOX_input,CELL_output,MODULE_output,WEATHER_output,THERMAL_output,ELECTRIC_output,CONVERSION_output, ...
    Irradiance_Year,Photon_flux_Year,V_opt1,V_opt2)
